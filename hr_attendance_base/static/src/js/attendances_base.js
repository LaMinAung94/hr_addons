    ...
    willStart: function () {
        return this._super.apply(this, arguments).then(result =>{
            ...
            if (this.controlPanelParams &&
                ...
                this.webcam_snapshot = this.controlPanelParams.context.webcam_snapshot;
                this.face_recognition_image = this.controlPanelParams.context.face_recognition_image;
